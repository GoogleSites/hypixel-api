declare module "hypixel-api-v2" {
    ...
    class HypixelAPI {
        ...
        get resources(): {
            ...
            guild: {
                achievements: () => Promise<{
                    one_time: OneTimeAchievement[];
                    tiered: TieredAchievement[];
                }>;
                permissions: () => Promise<{
                    en_us: GuildPermission;
                }[]>;
            };
            skyblock: {
                collections: () => Promise<{
                    [x: string]: {
                        name: string;
                        items: {
                            [x: string]: SkyblockCollection;
                        };
                    };
                }>;
                skills: () => Promise<{
                    [x: string]: SkyblockSkill;
                }>;
            };
        };
        get skyblock(): {
            news: () => Promise<SkyblockNews[]>;
            ...
            endedAuctions: () => Promise<{
                lastUpdated: number;
                auctions: EndedAuction[];
            }>;
            bazaar: () => Promise<{
                [x: string]: SkyblockBazaar;
            }>;
            profile: () => Promise<SkyblockProfile>;
            profiles: () => Promise<SkyblockProfile[]>;
        };
        /**
